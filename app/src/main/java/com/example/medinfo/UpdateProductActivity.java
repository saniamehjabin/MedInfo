...
public class UpdateProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextSideEffects = findViewById(R.id.edit_text_product_side_effects);
        editTextDosage = findViewById(R.id.edit_text_product_dosage);
    ...
    private void searchProduct() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            editTextSideEffects.setText(sideEffects);
            editTextPrice.setText(String.valueOf(price));
            editTextDosage.setText(String.valueOf(dosage));
    ...
    private void updateProduct() {
        ...
        String productDosage = editTextDosage.getText().toString().trim();
        String productDescription = editTextDescription.getText().toString().trim();
        String productSideEffects = editTextSideEffects.getText().toString().trim();

        if (productName.isEmpty() || productPrice.isEmpty() || productDosage.isEmpty() || productDescription.isEmpty() || productSideEffects.isEmpty()) {
            Toast.makeText(this, "Please fill all fields", Toast.LENGTH_SHORT).show();
            return;
        }

        double price = Double.parseDouble(productPrice);
        int dosage = Integer.parseInt(productDosage);

        String productIdText = textViewProductId.getText().toString();
        int productId = Integer.parseInt(productIdText.replaceAll("\\D+", ""));

        databaseHelper.updateProduct(productId, productName, price, productDescription, dosage, productSideEffects, productImageByteArray);

        Toast.makeText(UpdateProductActivity.this, "Successfully updated!", Toast.LENGTH_SHORT).show();
